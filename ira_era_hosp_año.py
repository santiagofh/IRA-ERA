...
year_range = st.sidebar.slider('Seleccione el intervalo de años', 2018, 2024, 2025 (2018, 2025))
...
total_resp = ['Hospitalizaciones - Sistema Respiratorio']
...
def grafico_barras_atenciones_por_año(df, col, title):
    ...
    fig.update_layout(
        title=title,
        xaxis_title='N° de Hospitalizaciones',
        yaxis_title='Año',
        legend_title='Año',
        template=GLOBAL_THEME,
        xaxis=dict(
...
#%%
st.header(f'Hospitalizaciones por causas respiratorias y por COVID por años en {hospital}, RM')
# Ejemplo de uso
