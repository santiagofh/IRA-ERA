...
pg =st.navigation([
    ...
    st.Page('ira_era_au_resp.py', title="Urgencias Respiratorias", icon=":material/monitoring:"),
    st.Page('ira_era_au_año.py', title="Urgencia Respiratorios por años", icon=":material/monitoring:"),
    st.Page('ira_era_endemico.py', title="Urgencia Corredor Endémico", icon=":material/monitoring:"),
])
